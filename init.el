...
(global-set-key (kbd "C-x C-j") 'php-doc-block)
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(dotenv-mode terraform-mode scala-mode groovy-mode yaml-mode json-mode dockerfile-mode yasnippet nyan-mode markdown-mode flycheck phpcbf anzu doom-modeline doom-themes material-theme color-theme-sanityinc-tomorrow monokai-theme editorconfig php-mode neotree web-mode))
